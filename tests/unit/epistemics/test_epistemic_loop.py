...
class TestLoopCreation:
    ...
    def test_create_full(
        ...
        loop = EpistemicLoop(
            graph=graph, workspace=workspace,
            memory=memory, calibration=calibrator,
            counterfactual=cf, calibration_interval=3,
        )
...
class TestCalibrationAutoSwitch:
    ...
    async def test_calibration_runs_at_interval(
        ...
        loop = EpistemicLoop(
            ...
            calibration=calibrator, calibration_interval=2,
        )
