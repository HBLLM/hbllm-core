...
**Module:** `hbllm.brain.core.brain_container.BrainContainer`

Single entry point that constructs and wires the entire cognitive system.

```python
from hbllm.brain.core.brain_container import BrainContainer, BrainConfig
...
**Module:** `hbllm.brain.core.brain_context.BrainContext`
...
**Module:** `hbllm.brain.skills.capability_registry.CapabilityRegistry`
...
**Module:** `hbllm.brain.core.trace.TraceCollector`
...
**Module:** `hbllm.brain.world.simulation_engine.DeliberationBudget`
...
**Module:** `hbllm.brain.reasoning.evidence.EvidencePacket`

Insulates reasoners from `BeliefGraph` internals. Provides everything a reasoner needs to evaluate trustworthiness.

```python
from hbllm.brain.reasoning.evidence import EvidencePacket, EvidenceBuilder
...
**Module:** `hbllm.brain.skills.skill_registry.SkillRegistry`
...
**Module:** `hbllm.brain.emotion.goal_manager.GoalManager`
...
**Module:** `hbllm.brain.self_model.self_model.SelfModel`
...
**Module:** `hbllm.brain.self_model.cognitive_metrics.CognitiveMetrics`
...
**Module:** `hbllm.brain.governance.policy_engine.PolicyEngine`
...
**Module:** `hbllm.brain.governance.owner_rules.OwnerRuleStore`
...
**Module:** `hbllm.brain.evaluation.evaluation_node.EvaluationNode`  
...
**Module:** `hbllm.brain.skills.skill_compiler_node.SkillCompilerNode`  
...
**Module:** `hbllm.brain.emotion.reflection_node.ReflectionNode`  
...
**Module:** `hbllm.brain.self_model.attention_manager.AttentionManager`  
...
**Module:** `hbllm.brain.control.load_manager.LoadManager`  
...
**Module:** `hbllm.brain.self_model.confidence_estimator.ConfidenceEstimator`
...
**Module:** `hbllm.brain.learning.learner_node.LearnerNode`
...
**Module:** `hbllm.brain.world.collective_node.CollectiveNode`
...
**Module:** `hbllm.brain.control.scheduler_node.SchedulerNode`
...
**Module:** `hbllm.brain.reasoning.context_fusion.ContextFusionEngine`
...
**Module:** `hbllm.brain.emotion.emotion_engine.EmotionEngine`
...
**Module:** `hbllm.brain.world.project_graph.ProjectGraph`
...
**Modules:** `hbllm.brain.control.executive_cortex.CognitiveExecutiveController`, `hbllm.brain.control.executive_cortex.ExecutiveCortex`
**State Model:** `hbllm.brain.core.cognitive_state.CognitiveState`
**Database Model:** `hbllm.brain.planning.intentional_workspace.IntentionalWorkspace`
...
**Module:** `hbllm.brain.social.relationship_memory.RelationshipMemory`
...
**Module:** `hbllm.brain.reasoning.reality_graph.RealityGraph`
