...
## Causal Cognition Graph (`hbllm/brain/causality/causal_graph.py`)
...
## Single-Query Trace API (`hbllm/brain/observability/tracer.py`)
...
## Cognitive Compaction Engine (`hbllm/brain/compaction/engine.py`)
