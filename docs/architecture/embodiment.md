...
| **Topological Pushing** | `gym_sokoban` (v0.0.6) | 82–85% (DRC(3,3), 1B steps) | **73.3%** Native Success (11/15)<br>**0 deadlocks** across all tiers | Line deadlock detection (`PhysicsPredictor.is_line_deadlock()`) & frozen box hashing |
